...
) ENGINE=InnoDB AUTO_INCREMENT=1364663 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=85178 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `code_books`
--

DROP TABLE IF EXISTS `code_books`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `code_books` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `codes` (
  ...
  `description` varchar(255) DEFAULT NULL,
  `measurement_level` varchar(255) DEFAULT NULL,
  `row` int(11) NOT NULL,
  `col` int(11) NOT NULL,
  `item_choice_id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=5391 DEFAULT CHARSET=utf8 COLLATE=utf8_danish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `item_choices` (
  ...
  `no_options` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=10044 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5215 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `score_rapports` (
  ...
  `center_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12819 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=132121 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=9040 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10051 DEFAULT CHARSET=utf8 COLLATE=utf8_danish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2011-06-08 12:05:55
