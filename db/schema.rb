...
ActiveRecord::Schema.define(:version => 20110105182159) do
  ...
  add_index "csv_score_rapports", ["age"], :name => "index_csv_score_rapports_on_age"
  add_index "csv_score_rapports", ["center_id"], :name => "index_csv_score_rapports_on_center_id"
  add_index "csv_score_rapports", ["survey_answer_id"], :name => "index_csv_score_rapports_on_survey_answer_id", :unique => true
  add_index "csv_score_rapports", ["team_id"], :name => "index_csv_score_rapports_on_team_id"
  ...
  add_index "journal_infos", ["center_id"], :name => "index_journal_infos_on_center_id"
  add_index "journal_infos", ["journal_id"], :name => "index_journal_infos_on_journal_id", :unique => true
  add_index "journal_infos", ["team_id"], :name => "index_journal_infos_on_team_id"
