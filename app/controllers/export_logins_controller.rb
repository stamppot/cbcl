...
#     filename = team.title.underscore + "_logins-" + Time.now.strftime("%Y%m%d%H%M")
...
#       wants.csv { send_data content, :filename => filename, :type => "text/csv;charset=utf-8; encoding=utf-8", :disposition => 'attachment' }
