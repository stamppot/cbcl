...
class UsersTest < ActiveSupport::TestCase #ActiveSupport::TestCase
  ...
  context "behandler" do
    setup do
      ...
      @teamadmin_role = [roles(:teamadmin)] 
  ...
  def test_user_can_pass_on_own_roles
    ...
    assert_all @user_center2.pass_on_roles, Role.get(:centeradmin, :teamadmin, :behandler)
  end
  
  # superadmins can see all users
  # admin can see no users in centers or centeradmins (so only other admins)
  # :centeradmins can see all users in center
