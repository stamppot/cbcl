    ...
    module Core
      ...
      def self.included(base)
        base.class_eval do
          ...
          has_and_belongs_to_many :groups, :uniq => true do
            def teams
          ...
          # We don't want to assign things to roles and groups and center in bulk assigns.
          attr_protected :roles, :groups, :center, :created_at, :updated_at, :last_logged_in_at, :login_failure_count, :password_hash_type, :password, :password_confirmation
          ...
          protected
            ...
            def validate
              ...
              # puts "@new_password: #{@new_password}  password: #{password}"
